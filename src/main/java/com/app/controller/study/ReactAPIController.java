...
public class ReactAPIController {
	...
	public String loginCheckJWT(@RequestBody Member member, HttpServletRequest request){
		
		//token 열어보고, 유효한 토큰인지 -> 누가 로그인 했는지 -> 로직실행(DB정보조회) -> return
